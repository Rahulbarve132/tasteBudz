      ...
      <div className="flex lg:mx-[20%] my-5 md:my-8 gap-7 justify-between flex-col md:flex-row">
        ...
        <div className="flex flex-col gap-2 w-full md:w-fit">
          ...
          <article className="bg-orange-100 border-2 border-orange-400 hover:shadow-md flex flex-col items-center w-full md:w-64 p-7 lg:p-5 text-lg rounded-md">
            ...
            <h5 className="font-medium text-base">rahulbarve132@gmail.com</h5>
            <a href="mailto:rakhi.kumaribce@gmail.com" target="_blank" className="text-sm hover:text-orange-700 font-medium">
              Send a message
            </a>
          </article>
        ...
        <form ref={form}  className="flex gap-2 flex-col w-full">
          <input
            type="text"
            name="name"
          ...
          />
          <input type="text" name="email" placeholder="Your Email" required className="border-orange-400 border-2 p-3 rounded-md focus:outline-none hover:shadow-md"/>
          <textarea
          ...
          ></textarea>
          <button type="submit" className="p-3 rounded-md font-medium hover:shadow-md hover:font-bold  bg-orange-200 border-2 border-orange-400">
            Send Message
          </button>
        </form>
      </div>
